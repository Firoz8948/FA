...
export const LockScreen: React.FC<LockScreenProps> = ({ onUnlock }) => {
  ...
  const handlePasswordSubmit = React.useCallback((input: string) => {
    ...
    if (matched) {
      ...
      // Select a hint based on attempts or random
      const randomHint = PASSWORDS[attempts % PASSWORDS.length].hint;
      setHint(randomHint);
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center p-4 bg-gradient-to-br from-pink-light via-cream to-white">
      ...
      {/* Decorative Hearts */}
      <div className="absolute top-10 left-10 text-pink-light/40 -rotate-12">
        <svg width="100" height="100" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
        </svg>
      </div>
      <div className="absolute bottom-20 right-10 text-pink-light/40 rotate-12">
